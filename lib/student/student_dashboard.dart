  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        // Filter items based on user gender
        final filteredDocs = docs.where((doc) {
          final id = doc.id;
          if (id.isNotEmpty) {
            final lastChar = id[id.length - 1];
            return lastChar == userGender;
          }
          return false;
        }).toList();

        if (filteredDocs.isEmpty) {
          return const Center(child: Text("No extra menu items available for your category."));
        }
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    if (isActive && endTime != null)
                      Text(
                        "Available until: ${endTime.hour}:${endTime.minute.toString().padLeft(2, '0')}",
